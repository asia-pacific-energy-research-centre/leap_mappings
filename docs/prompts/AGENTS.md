...
| `promote_separate_axis_and_run_full_system_20260730.md` | Active production integration | Merge the separate-axis and diagnostic branches, promote the generated compatibility contract, run the complete four-source mapping pipeline, and validate every available dashboard economy against the same run ID. |

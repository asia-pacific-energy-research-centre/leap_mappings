...
| [`documentation_audit_20260817.md`](documentation_audit_20260817.md) | Current re-review of the single-axis generation gate, typed outputs, workflow inventory, prompt status, and post-July documentation drift. |
